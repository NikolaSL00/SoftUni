...
public class WizardDeposits {
    ...
    @Column(name = "magi_wand_creator",length = 100)
    ...
    private LocalDateTime getDepositExpirationDate;
    ...
    public LocalDateTime getGetDepositExpirationDate() {
        return getDepositExpirationDate;
    }

    public void setGetDepositExpirationDate(LocalDateTime getDepositExpirationDate) {
        this.getDepositExpirationDate = getDepositExpirationDate;
    }
