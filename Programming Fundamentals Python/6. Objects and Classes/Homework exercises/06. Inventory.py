# Create a class Inventory. The __init__ method should accept only the __capacity (private attribute)
# of the inventory. Each inventory should also have an attribute called items, where all the items will be stored.
